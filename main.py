...
# Set a logfile name
logfile(dir_path + "/chertseyradioclub.log")
...
name = "ISS (ZARYA)"
l1 = "1 25544U 98067A   20034.66618427  .00001970  00000-0  43728-4 0  9994"
l2 = "2 25544  51.6425 294.0632 0005380 226.3931 219.2527 15.49140727211162"
...
while (now_time < start_time + timedelta(minutes=178)):
    try:
        ...
        cam.capture(dir_path + "/CRC-pic_" + str(photo_counter).zfill(3) + ".jpg")
        photo_counter += 1
